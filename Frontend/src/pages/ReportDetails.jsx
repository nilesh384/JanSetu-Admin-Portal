...
export default function ReportDetails() {
  ...
  const getStatusBadge = (status) => {
    const statusConfig = {
      pending: { label: 'Pending', color: 'bg-orange-100 text-orange-800 border-orange-200', dot: 'bg-orange-500' },
      assigned: { label: 'Assigned', color: 'bg-purple-100 text-purple-800 border-purple-200', dot: 'bg-purple-500' },
      in_progress: { label: 'In Progress', color: 'bg-blue-100 text-blue-800 border-blue-200', dot: 'bg-blue-500' },
      resolved: { label: 'Completed', color: 'bg-green-100 text-green-800 border-green-200', dot: 'bg-green-500' },
    ...
    return (
      <span className={`inline-flex items-center gap-1.5 px-3 py-1 text-xs font-medium rounded-full border ${badge.color}`}>
